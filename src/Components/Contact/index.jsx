          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="mr-2 bg-transparent dark:bg-gray-800 sm:rounded-lg">
                <h1 className="text-xl font-extrabold tracking-tight text-white sm:text-5xl dark:text-white">
                  Get in touch
                </h1>
              ...
              >
                ...
                <button
                  type="submit"
                  className="px-6 py-3 mt-3 font-bold text-black transition duration-300 ease-in-out bg-white border border-white rounded-lg md:w-32 hover:bg-blue-dark hover:bg-white hover:text-black"
                >
                  Submit
                </button>
              </form>
